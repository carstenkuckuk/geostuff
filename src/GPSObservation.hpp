...
{
public:
	GPSObservation(int nDateTime=0, double dLat=0.0, double dLong=0.0, double dElevationAboveSealevelInMeters=0.0, double dVelocity_km_per_hour=0.0, std::string strComment="x")
	...
	int m_nDateTime; // WigleWife Date Time Format
